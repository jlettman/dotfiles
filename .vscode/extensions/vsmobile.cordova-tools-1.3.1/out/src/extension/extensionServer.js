...
class ExtensionServer {
    constructor(pluginSimulator, projectRoot) {
        ...
        this.messageHandlerDictionary[extensionMessaging_1.ExtensionMessage.GET_RUN_ARGUMENTS] = this.getRunArguments;
    }
    /**
     * Starts the server.
     */
     ...
     * Returns info about the running simulate server
     */
    launchSimulateServer(fsPath, simulateOptions, projectType) {
    ...
    getRunArguments(fsPath) {
        return Q.resolve(cordovaCommandHelper_1.CordovaCommandHelper.getRunArguments(fsPath));
    }
}
