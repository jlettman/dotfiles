...
class ThreadAdapter extends events_1.EventEmitter {
    ...
    init(exceptionBreakpoints, reload) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (reload) {
                yield this.evaluate('location.reload(true)', false);
            }
        });
    }
    ...
    findSourceAdaptersForPathOrUrl(pathOrUrl) {
        if (!pathOrUrl)
            return [];
        return this.sources.filter((sourceAdapter) => (sourceAdapter.sourcePath === pathOrUrl) || (sourceAdapter.actor.url === pathOrUrl));
    }
    ...
    fetchVariables(variablesProvider) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let variableAdapters = yield this.coordinator.runOnPausedThread(() => variablesProvider.getVariables());
