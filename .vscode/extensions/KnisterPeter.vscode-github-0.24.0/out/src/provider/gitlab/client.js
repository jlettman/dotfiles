...
class GitLabClient {
    constructor(protocol, hostname, token, logger) {
        this.name = 'GitLab Client';
        this.client = api_1.getClient(this.getApiEndpoint(protocol, hostname), token, logger);
    }
    ...
    getRepository(uri, rid) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = (yield this.client.getProject(encodeURIComponent(rid))).body;
            return {
