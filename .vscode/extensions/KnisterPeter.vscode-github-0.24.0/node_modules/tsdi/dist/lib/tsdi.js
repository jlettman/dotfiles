...
var TSDI = (function () {
    ...
    TSDI.prototype.close = function () {
        ...
        Object.keys(this.instances).forEach(function (key) {
            ...
            if (!helper_1.isFactoryMetadata(metadata)) {
                var instance = _this.instances[idx];
                _this.notifyOnDestroy(instance);
    ...
    TSDI.prototype.throwComponentNotFoundError = function (component, name) {
        if (component && !name) {
            name = component.name;
        }
        if (!name) {
    ...
    TSDI.prototype.getConstructorParameters = function (metadata) {
        ...
        if (parameterMetadata) {
            return parameterMetadata
                ...
                .map(function (parameter) { return ({ index: _this.getComponentMetadataIndex(parameter.rtti, parameter.options.name), parameter: parameter }); })
                .map(function (_a) {
                var index = _a.index, parameter = _a.parameter;
    ...
    TSDI.prototype.getOrCreate = function (metadata, idx) {
        ...
        if (!instance || !this.isSingleton(metadata)) {
            if (helper_1.isFactoryMetadata(metadata)) {
                ...
                instance = new (constructor.bind.apply(constructor, [void 0].concat(parameters)))();
    ...
    TSDI.prototype.injectIntoInstance = function (instance, componentMetadata) {
    ...
    TSDI.prototype.injectDependency = function (instance, inject) {
        ...
        if (inject.options.lazy) {
            ...
            Object.defineProperty(instance, inject.property, {
                ...
                enumerable: true,
                get: function () {
                    var value = instance["tsdi$" + inject.property];
                    if (!value) {
                        log('lazy-resolve injected property %s.%s', instance.constructor.name, inject.property);
                        value = tsdi_1.getComponentDependency(inject);
    ...
    TSDI.prototype.getComponentDependency = function (inject) {
        var _a = this.getInjectComponentMetadata(inject), injectMetadata = _a[0], injectIdx = _a[1];
