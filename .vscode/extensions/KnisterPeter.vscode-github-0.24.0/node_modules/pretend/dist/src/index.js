...
function buildUrl(tmpl, args, appendQuery) {
    ...
    var query = createQuery(appendQuery ? args[queryOrBodyIndex] : {});
...
function execute(instance, method, tmpl, args, sendBody, appendQuery) {
    var createUrlResult = buildUrl(tmpl, args, appendQuery);
    var url = createUrlResult[0];
    var queryOrBodyIndex = createUrlResult[1];
    var headers = prepareHeaders(instance);
    var body = sendBody ? JSON.stringify(args[appendQuery ? queryOrBodyIndex + 1 : queryOrBodyIndex]) : undefined;
