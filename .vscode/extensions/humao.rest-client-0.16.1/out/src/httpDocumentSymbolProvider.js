...
class HttpDocumentSymbolProvider {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let index = 0; index < requestRange.length; index++) {
                ...
                if (blockStart <= blockEnd) {
                    let text = yield variableProcessor_1.VariableProcessor.processRawRequest(lines.slice(blockStart, blockEnd + 1).join(os_1.EOL));
    ...
    getRequestSymbolInfo(text) {
        ...
        let request = parser.parseHttpRequest(text, vscode_1.window.activeTextEditor.document.fileName, true);
